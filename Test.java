...
@ScriptManifest(authors = { "Phantom866" }, category = "Testing", name = "testing")
	

	public class Test extends EnumScript<Test.STATE> implements
	        Painting {
	    ...
	    final long[] SPIDER_ID = {1946100832L, 3044695648L};
	    ...
	    public STATE handleState(STATE t) {
	        ...
	        case ATTACK:
	            ...
	            if (!Timing.waitChooseOption("Attack Guard",
